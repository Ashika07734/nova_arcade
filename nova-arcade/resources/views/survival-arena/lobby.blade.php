    ...
    <section class="panel-strong p-8 sm:p-10">
        <div class="flex flex-wrap items-start justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                @endif
                <button type="button" id="leave-match" class="rounded-full border border-rose-500/50 bg-rose-500/10 px-5 py-3 text-sm font-semibold uppercase tracking-[0.2em] text-rose-200 transition hover:bg-rose-500/20">Leave</button>
            </div>
        </div>
    </section>

    <div class="grid gap-6 lg:grid-cols-3">
        <div class="panel lg:col-span-2 p-6">
