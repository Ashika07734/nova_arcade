...
<div class="page-shell page-section space-y-8">
    ...
    <form method="GET" class="panel flex flex-wrap gap-3 p-4 sm:p-6">
                    ...
                    <tr class="bg-slate-950/40">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <img src="{{ $entry->user->avatar_url }}" alt="{{ $entry->user->username }}" class="h-10 w-10 rounded-full border border-slate-700">
                                <div>
